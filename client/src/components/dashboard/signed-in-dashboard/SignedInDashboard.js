        ...
        <form id="form-id" onSubmit={''}>
          ...
          <div id="search-div" className="container">
           ...
           />
            ...
            <div className="icon-holder-search" onClick={() => {console.log("hello")}}>
              <Button variant="contained" className="inner-holder">
              <i class="material-icons left search-button-icon search-icon-dashboard grey-text text-darken-3" >search</i>
